    ...
    <div style="padding: 24px 0 0;">
            ...
            <div style="overflow: hidden;">
                <div style="float: left; display: inline-block;">
                    ...
                    <span
                        ...
                        <span style="color: #1C1F34; vertical-align: inherit;">Jwark User</span>
                    </span>
                </div>
                <div style="float:right; text-align:right;">
                    ...
                    <span style="color:#6C757D;">  {{ __('messages.invoice_id') }}-</span><span style="color: #284A8A;"> {{ '#' . $bookingdata->id ?? '-'}}</span>
                </div>
            </div>
        </div>
        <div>
        ...
        <div class="bottom-section">
            ...
            <p style="margin:8px 0; font-size: 14px;">Payment is due upon receipt. By making a booking, you agree to our service terms, including payment
                ...
                <a href="#" style="text-decoration: none; color: #284A8A;">support@jwark.com.</a>
            </p>
        </div>
        <footer style="margin-top: 8px;">
            <div style="display: inline; vertical-align: middle; margin-right: 10px;">
                ...
                <a href="{{$generaldata->website}}" style="color: #284A8A;">{{ $generaldata->website}}</a>
