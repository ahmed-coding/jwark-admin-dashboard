...
class NotificationTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'whatsapp_subject' => 'Booking Update',
            'sms_subject' => 'Booking Update',
            'template_detail' => '<p>#[[ booking_id ]] - حالة الطلب ل [[ booking_services_name ]] لقد تغير الى [[ booking_status ]].</p>',
            'whatsapp_template_detail' => '<p>#[[ booking_id ]] - Status for [[ booking_services_name ]] has changed to [[ booking_status ]].</p>',
            'sms_template_detail' => '<p>#[[ booking_id ]] - Status for [[ booking_services_name ]] has changed to [[ booking_status ]].</p>',
            'mail_template_detail' => '<p>#[[ booking_id ]] - Status for [[ booking_services_name ]] has changed to [[ booking_status ]].</p>',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<p>#[[ booking_id ]] - حالة الطلب ل [[ booking_services_name ]] لقد تغيرت الى  [[ booking_status ]].</p>',
            'whatsapp_template_detail' => '<p>#[[ booking_id ]] - Status for [[ booking_services_name ]] has changed to [[ booking_status ]].</p>',
            'sms_template_detail' => '<p>#[[ booking_id ]] - Status for [[ booking_services_name ]] has changed to [[ booking_status ]].</p>',
            'mail_template_detail' => '<p>#[[ booking_id ]] - Status for [[ booking_services_name ]] has changed to [[ booking_status ]].</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'user_type' => 'provider',
            'status' => 1,
            'subject' => 'تم ارسال الافتة الترويجية',
            ...
            'template_detail' => '<p>تم ارسال لافتتك الترويجية بنجاح وهي قيد الانتظار للموافقة</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'user_type' => 'provider',
            'status' => 1,
            'subject' => 'تم قبول الافتة الترويجية',
            ...
            'template_detail' => '<p>تم قبول لافتتك الترويجية وهي متاحة الان</p>',
