...
class FrontendSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $jsonDataSection6 = '{"section_6":1,"title":"Elevate Your Experience with Our App","description":"Discover a Range of Jwark Services and Stay Updated on the Latest Offers and Deals by Downloading Our App!"}';
        ...
        $jsonDataSection8 = '{"section_8":1,"title":"Your Recent Views & Beyond","description":"Dependable Jwark Service for Your Repairs, Renovations, and Maintenance. Skillful Professionals, Timely Solutions, and Guaranteed Customer Satisfaction."}';
        ...
        $jsonDataLoginRegisterSection = '{"login_register":1,"title":"Welcome To Our Handyman","description":"Masterful Jwark Services: Fixing, Repairing, and Enhancing Your Space with Expertise, Simplifying Life, One Project at a Time."}';
